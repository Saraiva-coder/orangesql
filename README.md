...
| 📝 Prepared Statements | 📊 Materialized Views | 🗄️ Columnar Storage |
| 🔗 Foreign Keys | 🔄 Replication | 🔒 Encryption |
| 💾 Query Result Caching | 📁 Partitioning | 🕸️ Graph Queries |
...
| **Google Test** | 1.11+ | Unit testing | ⚠️ Optional |
| **Google Benchmark** | 1.7+ | Benchmarking | ⚠️ Optional |
| **pthread** | — | Threading (Linux/macOS) | ✅ Yes |
| **readline** | 8.0+ | CLI history | ⚠️ Optional |
